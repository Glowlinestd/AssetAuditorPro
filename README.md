...
- Naming Prefix — Validates naming conventions
- Texture Compression — Audits texture compression and settings
- Texture Max Size — Checks maximum texture size limits
- Texture Power of Two — Validates POT texture dimensions
